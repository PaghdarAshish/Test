...
describe('TaskListPaginatorComponent', () => {
    ...
    it('should define an adf-pagination', () => {
        const adfPagination = fixture.debugElement.query(By.css('.adf-pagination'));
        ...
        expect(pageSizeElement.nativeElement.innerText.trim()).toBe('CORE.PAGINATION.ITEMS_PER_PAGE  arrow_drop_down');
        expect(pageRange.nativeElement.innerText.trim()).toBe('CORE.PAGINATION.ITEMS_RANGE');
        expect(pageSize.nativeElement.innerText.trim()).toBe('');
    });
